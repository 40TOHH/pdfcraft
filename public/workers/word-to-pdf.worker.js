...
async function init(needsCJKFont = false) {
    ...
    await pyodide.loadPackage(self.location.origin + '/pymupdf-wasm/typing_extensions-4.12.2-py3-none-any.whl');
    await pyodide.loadPackage(self.location.origin + '/pymupdf-wasm/lxml-5.4.0-cp313-cp313-pyodide_2025_0_wasm32.whl');
    await pyodide.loadPackage(self.location.origin + '/pymupdf-wasm/python_docx-1.2.0-py3-none-any.whl');
