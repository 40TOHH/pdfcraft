...
async function init(needsCJKFont = false) {
    ...
    await pyodide.loadPackage('https://cdn.jsdelivr.net/gh/PDFCraftTool/pdfcraft@main/public/pymupdf-wasm/typing_extensions-4.12.2-py3-none-any.whl');
    ...
    await pyodide.loadPackage('https://cdn.jsdelivr.net/gh/PDFCraftTool/pdfcraft@main/public/pymupdf-wasm/python_docx-1.2.0-py3-none-any.whl');
